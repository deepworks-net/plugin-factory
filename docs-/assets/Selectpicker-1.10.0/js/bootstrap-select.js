(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      var hideBS = (this.$element.children('option').size() < this.options.hideSearchLessThan) ? "hidden" : "";
      var searchbox = this.options.liveSearch ?
      '<div class="bs-searchbox ' + hideBS + '">' +
